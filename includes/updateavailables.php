        ...
        <div class="panel panel-primary">
            <div class="panel-heading panel-title text-center wow fadeInDown">
                <span style="font-weight:bold; font-family:verdana;"><i class="glyphicon glyphicon-list-alt"></i> Availables List</span>
            </div>
              ...
              <table class="table table-responsive table-hover table-bordered table-condensed table-striped wow fadeInDown" width="100%">
              	<thead>
                	<tr style="background-color:#000; color:#FFF;">
                        ...
                        <td style="text-align:center; width:auto;" class="wow fadeInDown">SIZE</td>
					...
					if(mysql_num_rows($query)>0){
                    	...
                    	<tr style="font-size:16px; cursor:pointer;">
                            ...
                            <td class="wow fadeInDown"> <center><strong><?php echo $row['size'];?></strong></center></td>
                            ...
                            <td class="wow fadeInDown"> <center><img src="<?php echo $row['image'];?>" width="70px;" class="img-responsive img-rounded" /></center></td>
